...
const MaternityDashboard = () => {
    ...
    const metrics = useMemo(() => {
        ...
        return {
            ...
            deliveriesToday: deliveryRecords.filter(d => d.deliveryDate?.startsWith(today)).length,
            deliveriesThisWeek: deliveryRecords.filter(d => {
    ...
    }, [maternityPatients, deliveryRecords, ancVisits]);
    ...
    const handleRegisterPatient = async (formData) => {
        ...
        const firstANCVisit = {
            ...
            gestationWeeks: formData.currentWeeks,
            weight: null,
            bloodPressure: null,
            fundalHeight: null,
            fetalHeartRate: null,
            ...
            advice: 'Schedule full antenatal assessment',
